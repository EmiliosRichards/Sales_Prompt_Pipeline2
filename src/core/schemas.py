...
class PartnerMatchOnlyOutput(BaseModel):
    ...
    match_confidence: Optional[str] = Field(default=None, description="Decision tier for the match. Expected values: 'strong', 'weak', or 'no_match'.")
    overlap_type: Optional[str] = Field(default=None, description="Primary type of common ground. Expected values include 'audience', 'use_case', 'workflow', 'industry', or 'mixed'.")
    matched_partner_id: Optional[str] = Field(default=None, description="Stable identifier of the Golden Partner identified as the closest match.")
    ...
    target_evidence: Optional[List[str]] = Field(default_factory=list, description="Short evidence snippets copied or paraphrased from the target-company attributes that justify the match.")
    partner_evidence: Optional[List[str]] = Field(default_factory=list, description="Short evidence snippets copied or paraphrased from the candidate partner profile that justify the match.")
    runner_up_partner_id: Optional[str] = Field(default=None, description="Stable identifier of the second-best shortlisted partner, if relevant.")
    runner_up_partner_name: Optional[str] = Field(default=None, description="Name of the second-best shortlisted partner, if relevant.")
    shortlisted_partner_ids: Optional[List[str]] = Field(default_factory=list, description="IDs of the shortlisted partners presented to the reranker.")
    shortlisted_partner_names: Optional[List[str]] = Field(default_factory=list, description="Names of the shortlisted partners presented to the reranker.")
...
class GoldenPartnerMatchOutput(BaseModel):
    ...
    match_confidence: Optional[str] = Field(default=None, description="Decision tier for the selected partner relationship. Expected values: 'strong', 'weak', or 'no_match'.")
    overlap_type: Optional[str] = Field(default=None, description="Primary type of common ground used for the match decision.")
    match_rationale_features: Optional[List[str]] = Field(default_factory=list, description="List of key shared features or reasons provided by the LLM for the match.")
    target_evidence: Optional[List[str]] = Field(default_factory=list, description="Evidence snippets from the analyzed company used to justify the match decision.")
    partner_evidence: Optional[List[str]] = Field(default_factory=list, description="Evidence snippets from the matched partner profile used to justify the match decision.")
    ...
    matched_partner_id: Optional[str] = Field(default=None, description="Stable identifier of the Golden Partner identified by the matching stage.")
    matched_partner_name: Optional[str] = Field(default=None, description="Name of the Golden Partner identified by the LLM as the closest match.")
    matched_partner_description: Optional[str] = Field(default=None, description="The summary of the matched golden partner.")
    runner_up_partner_id: Optional[str] = Field(default=None, description="Stable identifier of the runner-up partner candidate, if available.")
    runner_up_partner_name: Optional[str] = Field(default=None, description="Name of the runner-up partner candidate, if available.")
    shortlisted_partner_ids: Optional[List[str]] = Field(default_factory=list, description="IDs of the shortlisted partners considered before the final decision.")
    shortlisted_partner_names: Optional[List[str]] = Field(default_factory=list, description="Names of the shortlisted partners considered before the final decision.")
    acceptance_reason: Optional[str] = Field(default=None, description="Pipeline-side explanation for why the match was accepted as strong, downgraded to weak, or treated as no-match.")
