    ...
    try:
        ...
        for item in output_data:
            ...
            row = {
                ...
                'retrieved_phone_number': None,
                'usable_phone_for_pitch': None,
                'phone_status': None,
                ...
                'matched_golden_partner_id': None,
                'match_confidence': None,
                'match_overlap_type': None,
                'target_match_evidence': None,
                'partner_match_evidence': None,
                'runner_up_partner_id': None,
                'runner_up_partner_name': None,
                'shortlisted_partner_ids': None,
                'shortlisted_partner_names': None,
                'match_acceptance_reason': None,
            ...
            if original_row_data is not None:
                row.update({
                    ...
                    'input_phone_number': original_row_data.get('input_phone_number'),
                    'retrieved_phone_number': original_row_data.get('retrieved_phone_number'),
                    'usable_phone_for_pitch': original_row_data.get('usable_phone_for_pitch'),
                    'phone_status': original_row_data.get('phone_status'),
            ...
            if item:
                row.update({
                    ...
                    'matched_golden_partner_id': item.matched_partner_id or '',
                    'match_confidence': item.match_confidence or '',
                    'match_overlap_type': item.overlap_type or '',
                    'target_match_evidence': "; ".join(item.target_evidence) if item.target_evidence else '',
                    'partner_match_evidence': "; ".join(item.partner_evidence) if item.partner_evidence else '',
                    'runner_up_partner_id': item.runner_up_partner_id or '',
                    'runner_up_partner_name': item.runner_up_partner_name or '',
                    'shortlisted_partner_ids': "; ".join(item.shortlisted_partner_ids) if item.shortlisted_partner_ids else '',
                    'shortlisted_partner_names': "; ".join(item.shortlisted_partner_names) if item.shortlisted_partner_names else '',
                    'match_acceptance_reason': item.acceptance_reason or '',
